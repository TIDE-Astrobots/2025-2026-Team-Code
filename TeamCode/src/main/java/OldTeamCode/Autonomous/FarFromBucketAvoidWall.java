 ...
 */
//@Config
@Autonomous(name = "Far From Bucket (Avoid Wall) V0.0.5")
public class FarFromBucketAvoidWall extends LinearOpMode {
...
//                    extendoRight.setTargetPosition(3000);
            ...
            //14.5 MOVE 4 INCHES BACK
            resetTask();
            while(true) {
                if(runOnce) {
                    runOnce = false;
                    moveDirectionInInches("back", 4);
                }
